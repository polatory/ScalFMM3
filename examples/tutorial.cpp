...
auto main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) -> int
{
    ...
    // Here we construct directly the interaction lits. If we not call this function
    // the interaction lists are built in the algorithm.
    // You can build it either in sequential or in parallel (OpenMP)
