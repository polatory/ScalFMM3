...
option(${CMAKE_PROJECT_NAME}_BUILD_DEVEL "Set to ON to build functions for development and debugging purposes" OFF)
option(${CMAKE_PROJECT_NAME}_DEBUG "Set to ON to use naive implementations (without optimizations)" OFF)
...
message( STATUS "${CMAKE_PROJECT_NAME}_BUILD_DEVEL =  ${${CMAKE_PROJECT_NAME}_BUILD_DEVEL}")
message( STATUS "${CMAKE_PROJECT_NAME}_DEBUG       =  ${${CMAKE_PROJECT_NAME}_DEBUG}")
