...
namespace scalfmm::operators
{
    ...
    class near_field_operator
    {
      ...
      private:
        ...
        matrix_kernel_type m_matrix_kernel;   ///<  the matrix kernel used int the near field
        int m_separation_criterion{matrix_kernel_type::separation_criterion};                  ///<  the separation criterion; used int the near field
