...
#pragma omp single nowait
        ...
        inline auto task_dep(Tree& tree, operators::fmm_operators<NearField, FarField> const& fmmoperators, unsigned int op = operators_to_proceed::all)
          -> void
        {
        ...
        inline auto task_dep(options::settings<S...> s, Tree& tree, operators::fmm_operators<NearField, FarField> const& fmmoperators,
        ...
        inline auto task_dep(TreeS& tree_source, TreeT& tree_target, operators::fmm_operators<NearField, FarField>const& fmmoperators,
                             unsigned int op = operators_to_proceed::all) -> void
        {
